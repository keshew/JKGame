...
struct ZeusSlotsView: View {
    ...
    let symbolArray = ["zeus1", "zeus2", "zeus3", "zeus4", "zeus5", "zeus6"]
        ...
        ZStack {
                                ...
                                .overlay {
                                    VStack(spacing: -10) {
                                        Text("BET:")
                                            .font(.custom("CherryBombOne-Regular", size: 22))
                                            .foregroundStyle(.white)
                                            .outlineText(color: .blue, width: 0.7)
            ...
            if isPaytable {
                ...
                ZStack(alignment: .topTrailing) {
                    Rectangle()
                        .fill(Color(red: 5/255, green: 39/255, blue: 123/255).opacity(0.4))
                        .overlay {
                            RoundedRectangle(cornerRadius: 16)
                                .stroke(Color(red: 0/255, green: 51/255, blue: 255/255).opacity(0.5), lineWidth: 8)
                                .overlay {
                                    LazyVGrid(columns: [GridItem(.flexible()), GridItem(.flexible())], spacing: 22) {
                                        ForEach(0..<6, id: \.self) { index in
                                            ZStack(alignment: .trailing) {
                                                Rectangle()
                                                    ...
                                                    .overlay {
                                                        RoundedRectangle(cornerRadius: 10)
                                                            .stroke(Color(red: 0/255, green: 51/255, blue: 255/255).opacity(0.3), lineWidth: 2)
                                                            .overlay {
                                                                HStack(spacing: 3) {
                                                ...
                                                Rectangle()
                                                    .fill(LinearGradient(colors: [Color(red: 0/255, green: 51/255, blue: 253/255),
                                                                                 Color(red: 4/255, green: 92/255, blue: 255/255)], startPoint: .leading, endPoint: .trailing))
